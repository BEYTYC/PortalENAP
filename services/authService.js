 ...
 *
 * Requiere: npm install @azure/msal-browser
 */
 ...
 * el popup de login. Nunca deja caer el error de MSAL sin envolverlo en
...
async function obtenerPerfilGraph(cuenta) {
  ...
  return resp.json(); // { mail, userPrincipalName, displayName, ... }
}
 ...
 * de SharePoint — estos son los nombres más probables, no un dato
 * confirmado; verificar contra la lista real antes de dar esto por
 * definitivo.
 */
